...
extension ByteBuffer {
    ...
    public mutating func readMultipleIntegers<T1: FixedWidthInteger, T2: FixedWidthInteger>(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v1) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T1>.size)
            }
            offset = offset &+ MemoryLayout<T1>.size
            withUnsafeMutableBytes(of: &v2) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T2>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v3) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T3>.size)
            }
    ...
    >(endianness: Endianness = .big, as: (T1, T2, T3, T4).Type = (T1, T2, T3, T4).self) -> (
        T1, T2, T3, T4
    )? {
        var bytesRequired: Int = MemoryLayout<T1>.size
        bytesRequired &+= MemoryLayout<T2>.size
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v4) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T4>.size)
            }
        ...
        case .little:
            return (
                T1(littleEndian: v1), T2(littleEndian: v2), T3(littleEndian: v3),
                T4(littleEndian: v4)
            )
        }
    }
    ...
    >(endianness: Endianness = .big, as: (T1, T2, T3, T4, T5).Type = (T1, T2, T3, T4, T5).self) -> (
        T1, T2, T3, T4, T5
    )? {
        var bytesRequired: Int = MemoryLayout<T1>.size
        bytesRequired &+= MemoryLayout<T2>.size
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v5) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T5>.size)
            }
        ...
        case .big:
            return (
                T1(bigEndian: v1), T2(bigEndian: v2), T3(bigEndian: v3), T4(bigEndian: v4),
                T5(bigEndian: v5)
            )
        case .little:
            return (
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v6) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T6>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v7) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T7>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v8) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T8>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v9) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T9>.size)
            }
    ...
    >(
        endianness: Endianness = .big,
        as: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10).Type = (
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v10) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T10>.size)
            }
    ...
    >(
        endianness: Endianness = .big,
        as: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11).Type = (
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v11) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T11>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v12) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T12>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v13) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T13>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v14) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T14>.size)
            }
    ...
    >(
        ...
        self.readWithUnsafeReadableBytes { ptr -> Int in
            ...
            withUnsafeMutableBytes(of: &v15) { destPtr in
                destPtr.baseAddress!.copyMemory(
                    from: basePtr + offset, byteCount: MemoryLayout<T15>.size)
            }
